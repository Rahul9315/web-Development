            ...
            <div class="row"><img class="imglogo" src="images/logo1.png"></div>
                ...
                <?php
                    ...
                    if ( isset($_POST['searchbook'])) 
                    {
                        ...
                        $sql = "SELECT * FROM category_table WHERE CategoryType LIKE '$search' ";
                        $answer = mysqli_query($connection, $sql);//important

                        if ($row1 = mysqli_fetch_array($answer)) {
                            
                            $id_Of_Category = $row1['CategoryID'];                         
                        }

                        $sql = "SELECT * FROM book_table WHERE Category LIKE '$id_Of_Category%' ";
